...
<div className="h-screen/4 flex flex-col justify-end pb-16" style={{
  ...
  backgroundPosition: 'center',
    ...
    <div className="w-full max-w-xl mx-auto " >
      <input
        className="appearance-none block w-full  bg-gray-800 text-white border border-gray-200 rounded-full py-3 px-4  leading-tight focus:outline-none focus:bg-gray-700 focus:border-gray-500 content-center"
        type="text"
        placeholder="Search..."
        value={searchQuery}
