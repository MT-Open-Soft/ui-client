...
const Sidebar = () => {
  ...
  const adminName = "John Doe"; // You can dynamically fetch or pass this value
  ...
  return (
    <div className="h-full w-64 bg-gray-900 text-white" style={{ padding: '10px', borderRight: '1px solid rgba(100,100,100,0.2)' }}>
      ...
      <li className="flex items-center space-x-2">
        ...
        <li className="flex items-center space-x-2">
          <FaRegPlusSquare className="text-blue-300 mr-2" size={20} />
          <span>Add Item</span>
        </li>
        <li className="flex items-center space-x-2">
          <MdModeEdit className="text-blue-300 mr-2" size={20} />
          <span>Edit Item</span>
        </li>
        <li className="flex items-center space-x-2">
