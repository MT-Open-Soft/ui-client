        ...
        <div className="text-md font-bold text-white lg:flex-grow">
          ...
          <div className="group inline-block relative">
            ...
            <ul className="absolute hidden text-gray-700 pt-1 group-hover:block w-32">
              ...
              <li><Link to="/documentary" className="bg-gray-200 hover:bg-gray-400 py-2 px-3 block whitespace-no-wrap">Documentary</Link></li>
              <li><Link to="/horror" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Horror</Link></li>
              <li><Link to="/Biography" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Biography</Link></li>
              <li><Link to="/family" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Family</Link></li>
              <li><Link to="/mystery" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Mystery</Link></li>
              <li><Link to="/fantasy" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Fantasy</Link></li>
              <li><Link to="/scifi" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Sci-Fi</Link></li>
              <li><Link to="/animation" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Animation</Link></li>
              <li><Link to="/history" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">History</Link></li>
              <li><Link to="/music" className="bg-gray-200 hover:bg-gray-400 py-2 px-6 block whitespace-no-wrap">Music</Link></li>
              <li><Link to="/war" className="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-6  block whitespace-no-wrap">War</Link></li>
